...
/*
 * DES key schedule encrypt only add by Benjamin CHARLES
 */
void des_set_key_esk( des_context_e *ctx, uchar key[8] )
{
    des_main_ks( ctx->esk, key );
}
...
static uchar DES3_init[8] =
{
    0x4E, 0x6F, 0x77, 0x20, 0x69, 0x73, 0x20, 0x74
};

static uchar DES3_enc_test[3][8] =
{
...
static uchar DES3_dec_test[3][8] =
{
...
int des_self_test( void )
{
    ...
    for( i = 0; i < 6; i++ )
    {
        ...
        switch( u )
        {
            case 0:    des_set_key( &ctx,  DES3_keys ); break;
            case 1: des3_set_2keys( &ctx3, DES3_keys ); break;
            case 2: des3_set_3keys( &ctx3, DES3_keys ); break;
        }
